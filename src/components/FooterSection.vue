        ...
        <section class="container">
            ...
            <nav class="footer-nav">
                <ul class="footer-menu">
                    <li class="footer-menu-item"><a href="javascript:;">FEATURES</a></li>
                    <li class="footer-menu-item"><a href="javascript:;">PRICING</a></li>
                    <li class="footer-menu-item"><a href="javascript:;">CONTACT</a></li>
                </ul>
...
.footer-rrss-item:first-child {
    margin-top: -.1rem;
}
.footer-rrss-item a svg path {
    transition: .3s;
}

.footer-rrss-item:hover svg path {
    fill: var(--soft-red);
}
