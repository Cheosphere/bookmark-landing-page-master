...
<template>
    <header>
        <figure class="logo">
            <a href="javascript:;">
                <svg :class="{ color: isColor }" width="148" height="25" xmlns="http://www.w3.org/2000/svg">
        ...
        <span @click="showMenu" :class="{ close: isClose }" class="icon-menu"></span>
    </header>
</template>
...
.login-btn {
    padding: .8rem 2.05rem .7rem 2.05rem;
    border-radius: 5px;
